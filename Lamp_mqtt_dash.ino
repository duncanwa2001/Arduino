...
//推播主題1:推播溫度(記得改Topic)
char* MQTTPubTopic1 = "Kuang2021/classtest/temp";
//推播主題2:推播濕度(記得改Topic)
char* MQTTPubTopic2 = "Kuang2021/classtest/humi";
//訂閱主題1:改變LED燈號(記得改Topic)
char* MQTTSubTopic1 = "Kuang2021/classtest/led";
...
void MQTTConnecte() {
  ...
  MQTTClient.setCallback(MQTTCallback);//訂閱主題有更新時，會執行MQTTCallback副程式
...
void MQTTCallback(char* topic, byte* payload, unsigned int length) {
  ...
  //比對主題是否為訂閱主題1，當結果為0時，代表兩比較字串所有字符都相同
